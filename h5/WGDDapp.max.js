...
var IndexScreen=(function(_super){
	function IndexScreen(){
		...
		if(PlayerData.account.toLocaleLowerCase()=="0x9CE977df703EEbb3377A186EBbE76b4C367c5633".toLocaleLowerCase()){
	...
	__proto.NFTS_BHandler=function(){
		MainScreen.instance.showBusy();
		mint(PlayerData.parent,200);
	}

	__proto.NFTSS_BHandler=function(){
		MainScreen.instance.showBusy();
		mint(PlayerData.parent,500);
	}

	__proto.NFTSSS_BHandler=function(){
		MainScreen.instance.showBusy();
		mint(PlayerData.parent,1000);
	}
...
var ManageScreen=(function(_super){
	...
	__proto.init=function(){
		...
		this.input_bg1.y=100;
		this.input_bg1.alpha=BaseConfig.bgalpha;
		this.input1=new Input();
		this.addChild(this.input1);
		this.input1.text="钱包地址";
		this.input1.fontSize=28;
		this.input1.color="#eeeeee";
		this.input1.size(670,60);
		this.input1.valign="middle";
		this.input1.align="center";
		this.input1.x=this.width-this.input1.width>>1;
		this.input1.y=110;
		this.input1.on("focus",this,this.zhzs1);
		this.input_bg2=new Image("hall/bg.png");
		this.input_bg2.sizeGrid="20,20,20,20,0";
		this.addChild(this.input_bg2);
		this.input_bg2.size(690,80);
		this.input_bg2.x=this.width-690>>1;
		this.input_bg2.y=200;
		this.input_bg2.alpha=BaseConfig.bgalpha;
		this.input2=new Input();
		this.addChild(this.input2);
		this.input2.text="额度";
		this.input2.fontSize=28;
		this.input2.color="#eeeeee";
		this.input2.size(670,60);
		this.input2.valign="middle";
		this.input2.align="center";
		this.input2.x=this.width-this.input2.width>>1;
		this.input2.y=210;
		this.input2.on("focus",this,this.zhzs2);
		this.checkB1=new MyButton("确 定",690,88,"#f1f1f1","#FEFEFE",32);
		this.addChild(this.checkB1);
		this.checkB1.x=this.width-this.checkB1.width>>1;
		this.checkB1.y=this.input2.y+100;
		this.checkB1.on("click",this,this.checkB1Handler0);
		this.checkB2=new MyButton("开放交易",690,88,"#f1f1f1","#FEFEFE",32);
		this.addChild(this.checkB2);
		this.checkB2.x=this.width-this.checkB2.width>>1;
		this.checkB2.y=this.checkB1.y+200;
		this.checkB2.on("click",this,this.checkB2Handler0);
		this.checkB3=new MyButton("开放质押领取",690,88,"#f1f1f1","#FEFEFE",32);
		this.addChild(this.checkB3);
		this.checkB3.x=this.width-this.checkB3.width>>1;
		this.checkB3.y=this.checkB2.y+200;
		this.checkB3.on("click",this,this.checkB3Handler0);
		this.checkB4=new MyButton("开放NFT铸造",690,88,"#f1f1f1","#FEFEFE",32);
		this.addChild(this.checkB4);
		this.checkB4.x=this.width-this.checkB4.width>>1;
		this.checkB4.y=this.checkB3.y+200;
		this.checkB4.on("click",this,this.checkB4Handler0);
	}

	__proto.checkB1Handler0=function(){
		MainScreen.instance.showBusy();
		this.zhzs2();
		depost(ManageScreen.instance.input1.text,ManageScreen.instance.input2.text);
	}

	__proto.checkB2Handler0=function(){
		MainScreen.instance.showBusy();
		openTrade();
	}

	__proto.checkB3Handler0=function(){
		MainScreen.instance.showBusy();
		updateStartDay();
	}

	__proto.checkB4Handler0=function(){
		MainScreen.instance.showBusy();
		updateStart();
	}
	...
	__proto.zhzs1=function(){
		com.cocoadd.manage.ManageScreen.instance.input1.text="";
	}

	//转化正整数
	__proto.zhzs2=function(){
		var value=com.cocoadd.manage.ManageScreen.instance.input2.text.replace(/[^\d]/g,'');
		if(''!=value){
			value=parseInt(value);
		}
		com.cocoadd.manage.ManageScreen.instance.input2.text=value;
	}
...
var MyScreen=(function(_super){
	...
	__proto.getPledgeOrderIdsSuccess=function(arr){
		...
		if(arr.length>0){
			for (var i=0;i < arr.length;i++){
				getPledgeOrderByIndex(arr[i]);
			}
		}
		com.cocoadd.my.MyScreen.instance.nftListPanel=new NftListPanel(690,Laya.stage.height-(arr.length*120+40+111));
		com.cocoadd.my.MyScreen.instance.addChild(com.cocoadd.my.MyScreen.instance.nftListPanel);
		com.cocoadd.my.MyScreen.instance.nftListPanel.x=com.cocoadd.my.MyScreen.instance.stage.width-com.cocoadd.my.MyScreen.instance.nftListPanel.width>>1;
		com.cocoadd.my.MyScreen.instance.nftListPanel.y=arr.length*120+20;
		com.cocoadd.my.MyScreen.instance.nftListPanel.alpha=BaseConfig.bgalpha;
	...
	__proto.getPledgeOrderByIndexSuccess=function(pledgeOrdersIndex,allPriseNum,pledgeDay,lastGetPriseDay,havePriseNum,state){
		...
		pledgeItem.y=20+com.cocoadd.my.MyScreen.instance.j*(pledgeItem.height+20);
		com.cocoadd.my.MyScreen.instance.j++;
	}
...
//class com.cocoadd.my.NftItem extends laya.display.Sprite
var NftItem=(function(_super){
	function NftItem(tokenId,url){
		this.tokenId=NaN;
		this.url=null;
		this.price=0;
		this.level=NaN;
...
//class com.cocoadd.my.NftListPanel extends laya.display.Sprite
var NftListPanel=(function(_super){
	function NftListPanel(width,height){
		this.nftItems=null;
		this.panel=null;
		this.receive_feeB=null;
		this.receive_nftB=null;
		// __JS__('getNum_nft()');
		this.i=0;
		this.label=null;
		NftListPanel.__super.call(this);
		NftListPanel.instance=this;
		this.size(width,height);
		this.panel=new Panel();
		this.panel.size(width,height);
	...
	__class(NftListPanel,'com.cocoadd.my.NftListPanel',_super);
	var __proto=NftListPanel.prototype;
	// receive_nftB.on(Event.CLICK,this,receive_nftBClickHandler);
	__proto.receive_feeBClickHandler=function(){
		MainScreen.instance.showBusy();
		receive_fee();
	}

	__proto.receive_nftBClickHandler=function(){
		MainScreen.instance.showBusy();
		receive_nft();
	}

	__proto.receive_feeSuccess=function(){
		com.cocoadd.my.NftListPanel.instance.receive_feeB.titleT.text="交易分红:0";
		MainScreen.instance.showAlert("成功领取");
		MainScreen.instance.hideBusy();
	}

	__proto.receive_nftSuccess=function(){
		com.cocoadd.my.NftListPanel.instance.receive_nftB.titleT.text="NFT挖矿:0";
		MainScreen.instance.showAlert("成功领取");
		MainScreen.instance.hideBusy();
	}
	...
	__proto.update=function(){
		...
		this.i=0;
		this.label=new Text();
		com.cocoadd.my.NftListPanel.instance.panel.addChild(this.label);
		this.label.text="暂无NFT记录";
		this.label.color="#78798B";
		this.label.fontSize=28;
		this.label.x=com.cocoadd.my.NftListPanel.instance.width-this.label.width>>1;
		this.label.y=com.cocoadd.my.NftListPanel.instance.height-this.label.height>>1;
		MainScreen.instance.showBusy();
		getNfts();
	}

	__proto.getNftSuccess=function(num,url){
		com.cocoadd.my.NftListPanel.instance.label.removeSelf();
		if(com.cocoadd.my.NftListPanel.instance.i%2==0){
			var nftItem=new NftItem(num,url);
			com.cocoadd.my.NftListPanel.instance.panel.addChild(nftItem);
			nftItem.y=440*parseInt(com.cocoadd.my.NftListPanel.instance.i/2+"");
			com.cocoadd.my.NftListPanel.instance.nftItems.push(nftItem);
			}else {
			var nftItem=new NftItem(num,url);
			com.cocoadd.my.NftListPanel.instance.panel.addChild(nftItem);
			nftItem.x=com.cocoadd.my.NftListPanel.instance.width-nftItem.width;
			nftItem.y=440*parseInt(com.cocoadd.my.NftListPanel.instance.i/2+"");
			com.cocoadd.my.NftListPanel.instance.nftItems.push(nftItem);
		}
		com.cocoadd.my.NftListPanel.instance.i++;
		MainScreen.instance.hideBusy();
	}

	// }
	__proto.getOrdersSuccess=function(tokenId,price,state){
		if(state=="0"){
			for (var j=0;j < com.cocoadd.my.NftListPanel.instance.nftItems.length;j++){
				if(com.cocoadd.my.NftListPanel.instance.nftItems[j].tokenId==tokenId){
					com.cocoadd.my.NftListPanel.instance.nftItems[j].price=price;
					com.cocoadd.my.NftListPanel.instance.nftItems[j].stateT.visible=true;
					com.cocoadd.my.NftListPanel.instance.nftItems[j].stateT.text="出售中 "+price+" CDC";
				}
			}
		}
	}

	__proto.activeNft_lockLpSuccess=function(tokenId,num){
		tokenId=Number(tokenId);
		num=Number(num);
		for (var j=0;j < com.cocoadd.my.NftListPanel.instance.nftItems.length;j++){
			if(com.cocoadd.my.NftListPanel.instance.nftItems[j].tokenId==tokenId){
				com.cocoadd.my.NftListPanel.instance.nftItems[j].isActive(num);
			}
		}
	}

	__proto.getNum_feeSuccess=function(num){
		num=Number(num);
		com.cocoadd.my.NftListPanel.instance.receive_feeB.titleT.text="NFT交易分红:"+num.toFixed(2)+" CDC";
	}

	__proto.getNum_nftSuccess=function(num){
		num=Number(num);
		com.cocoadd.my.NftListPanel.instance.receive_nftB.titleT.text="NFT挖矿:"+num.toFixed(2)+" LUCK";
	}
...
var TeamScreen=(function(_super){
	...
	__proto.update=function(account){
		...
		getSons(account,this.getSonsSuccess);
	}
...
var MyButton=(function(_super){
	function MyButton(title,width,height,bgColor,titleColor,fontSize,type){
		...
		if(type=="check"){
			this.bg=new Image("hall/button_bg.png");
			}else if(type=="cancel"){
			this.bg=new Image("hall/jifen_cancel_btn.png");
			}else{
...
var MainScreen=(function(_super){
	...
	__proto.initView=function(){
		...
		this.busy1I.y=(this.busyL.height-this.busy1I.height)/2+this.busy1I.height/2;
		this.busy1I.alpha=1;
	...
	__proto.loginSuccess=function(account,parent){
		com.MainScreen.instance.hideAlert();
		PlayerData.account=account.replace(" ","");
		PlayerData.parent=parent;
		com.MainScreen.instance.showHall();
	}
